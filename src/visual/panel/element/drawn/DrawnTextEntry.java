...
/**
 * 
 * Given increased complexity of the DrawnText class, will assume DrawnTextEntry uses
 * same Font and Color consistently
 * 
 */
...
//---  Constructors   -------------------------------------------------------------------------
	...
	public DrawnTextEntry(int inX, int inY, int wid, int hei, int prior, boolean centerX, boolean centerY, boolean centerText, String word, Font inFont, int inCode) {
		super(inX, inY, wid, hei, prior, centerX, centerY, centerText, new TextSegmentComposite(word, inFont, Color.black));
		code = inCode;
		font = inFont;
...
//---  Setter Methods   -----------------------------------------------------------------------
	...
	public void setText(String text) {
		...
		changeText(new TextSegmentComposite(text, getFont(), Color.black));
		index = text.length();
	}
